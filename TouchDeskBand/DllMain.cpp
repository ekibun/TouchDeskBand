...
//2c43af31-6214-4ca1-9837-6d441a2aee6f
CLSID CLSID_Touch = { 0x2c43af31, 0x6214, 0x4ca1,{ 0x98, 0x37, 0x6d, 0x44, 0x1a, 0x2a, 0xee, 0x6f} };

HINSTANCE   g_hInst = NULL;
long        g_cDllRef = 0;
bool        g_canUnload = false;
...
STDAPI DllGetClassObject(REFCLSID rclsid, REFIID riid, void **ppv)
{
	...
	if (IsEqualCLSID(CLSID_Touch, rclsid))
	{
		hr = E_OUTOFMEMORY;
...
HRESULT RegisterServer()
{
	...
	StringFromGUID2(CLSID_Touch, szCLSID, ARRAYSIZE(szCLSID));
...
HRESULT RegisterComCat()
{
	...
	if (SUCCEEDED(hr))
	{
		...
		hr = pcr->RegisterClassImplCategories(CLSID_Touch, 1, &catid);
		pcr->Release();
	}
	return hr;
}
